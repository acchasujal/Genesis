...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Genesis features a total prize pool of ₹100k, including cash rewards of ₹50,000 for the top three teams in the AI and Sustainability domains . The Cyrene AI (Blockchain) track offers 100USDC to the 4 winning teams, with goodies and exciting prizes to all participants.',
  },
  {
